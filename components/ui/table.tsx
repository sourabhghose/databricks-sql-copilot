  ...
  return (
    <tr
      ...
      className={cn(
        ...
        /* L3 hover: clear affordance */
        "hover:bg-row-hover",
        /* L3 selected: bg shift + left accent */
        "data-[state=selected]:bg-row-selected data-[state=selected]:border-l-2 data-[state=selected]:border-l-row-accent",
        className,
      )}
      {...props}
    />
